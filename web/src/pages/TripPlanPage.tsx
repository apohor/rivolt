          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-4">
            <label className="flex flex-col gap-1 text-sm">
              ...
              <input
                ...
                className="rounded-md border border-neutral-700 bg-neutral-900 px-3 py-2 text-neutral-100 placeholder-neutral-600 focus:border-neutral-500 focus:outline-hidden"
              />
            </label>
            <label className="flex flex-col gap-1 text-sm">
              ...
              {overnightLimitMode === "soc" && (
                <label className="flex items-center gap-1">
                  <input
                    ...
                    className="w-16 rounded-sm border border-neutral-700 bg-neutral-900 px-2 py-0.5 text-neutral-200 tabular-nums"
                  />
              ...
              {overnightLimitMode === "depart" && (
                ...
                >
                  ...
                  <input
                    ...
                    className="rounded-sm border border-neutral-700 bg-neutral-900 px-2 py-0.5 text-neutral-200 tabular-nums"
                  />
    ...
    <Card title="Saved trips">
      ...
      <form onSubmit={submit} className="flex flex-wrap items-center gap-2">
        <input
          ...
          className="flex-1 min-w-48 rounded-md border border-neutral-700 bg-neutral-900 px-3 py-1.5 text-sm text-neutral-100 placeholder-neutral-600 focus:border-neutral-500 focus:outline-hidden"
        />
        <button
          type="submit"
  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-2 rounded-md border border-neutral-700 bg-neutral-900 px-3 py-2 text-neutral-100 hover:border-neutral-500 focus:outline-hidden"
      >
        ...
        <div className="absolute z-20 mt-1 w-72 rounded-md border border-neutral-700 bg-neutral-900 p-3 shadow-lg">
          <div className="mb-2 flex items-center justify-between">
            <button
              ...
              className="rounded-sm px-2 py-1 text-neutral-400 hover:bg-neutral-800 hover:text-neutral-100"
            >‹</button>
...
function ScrollColumn({
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="h-40 w-12 overflow-y-auto rounded-sm border border-neutral-800">
        {options.map((opt) => (
          <button
            key={opt}
            type="button"
    ...
    <div className="rounded-lg border border-neutral-800 bg-neutral-950/40 p-3">
      <div className="flex items-baseline justify-between gap-3">
        <div className="text-sm">
          ...
          {value ? (
            value.label === "Home" ? (
              <span className="rounded-sm border border-emerald-700 bg-emerald-950/40 px-1.5 py-0.5 text-emerald-300">
                🏠 Home
              </span>
            ) : (
    ...
    <div className="relative" ref={containerRef}>
      <div className="relative">
        <input
          ...
          className="w-full rounded-md border border-neutral-700 bg-neutral-900 px-3 py-2 pr-8 text-neutral-100 focus:border-neutral-500 focus:outline-hidden"
        />
...
function TripAdviceCard({
  ...
  return (
    <Card title="Trip analysis">
      ...
      {advice && (
        <>
          {/* Single toggle row at the TOP of the card — the
              right-side label flips between "Tap to view" (when
              collapsed) and "Tap to collapse" (when expanded) so the
              affordance never moves under the user's cursor. */}
          <button
            type="button"
            onClick={() => setExpanded((v) => !v)}
          ...
          {expanded && (
            <div className="space-y-4 mt-3">
              ...
              {advice.model && (
                <p className="pt-1 border-t border-neutral-800/60 text-xs text-neutral-600">
                  {advice.model}
                </p>
              )}
            </div>
          ...
          return (
            <div key={d.index} className="rounded-lg border border-neutral-800 bg-neutral-950/40 p-3">
              <div className="mb-3 flex flex-wrap items-baseline gap-x-3 gap-y-1">
                <span className="rounded-sm bg-emerald-900/40 px-1.5 py-0.5 text-xs font-semibold text-emerald-200">
                  Day {d.index}
                </span>
                ...
                {isLongDay && (
                  <span
                    className="rounded-sm bg-amber-900/40 px-1.5 py-0.5 text-xs text-amber-300"
