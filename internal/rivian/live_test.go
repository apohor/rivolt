		...
		writeJSON(w, map[string]any{
			"data": map[string]any{
				"vehicleState": map[string]any{
					...
					"chargerPower":                    map[string]any{"value": 0.0},
					"chargerDerateStatus":             map[string]any{"value": "none"},
					"chargeTarget":                    map[string]any{"value": 80.0},
					"cabinClimateInteriorTemperature": map[string]any{"value": 21.0},
					"cabinClimateExteriorTemperature": map[string]any{"value": 18.0},
					"closureFrontLeftLocked":          map[string]any{"value": "locked"},
				},
			},
		})
	default:
