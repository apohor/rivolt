		...
		writeJSON(w, map[string]any{
			"data": map[string]any{
				"vehicleState": map[string]any{
					...
					"gnssBearing":                     map[string]any{"value": 90.0},
					"gnssAltitude":                    map[string]any{"value": 52.0},
					"batteryLevel":                    map[string]any{"value": 72.5},
					"distanceToEmpty":                 map[string]any{"value": 310.0},
					"vehicleMileage":                  map[string]any{"value": 24500000.0},
					...
					"chargePortState":                 map[string]any{"value": "closed"},
					"remoteChargingAvailable":         map[string]any{"value": "true"},
					"cabinClimateInteriorTemperature": map[string]any{"value": 21.0},
					"cabinPreconditioningStatus":      map[string]any{"value": "inactive"},
					"powerState":                      map[string]any{"value": "sleep"},
					"alarmSoundStatus":                map[string]any{"value": "false"},
					"twelveVoltBatteryHealth":         map[string]any{"value": "good"},
					"wiperFluidState":                 map[string]any{"value": "normal"},
					"otaCurrentVersion":               map[string]any{"value": "2025.40.00"},
					"otaAvailableVersion":             map[string]any{"value": "2025.40.00"},
					"otaStatus":                       map[string]any{"value": "Idle"},
					"otaInstallProgress":              map[string]any{"value": 0.0},
					"tirePressureFrontLeft":           map[string]any{"value": 2.6},
					"tirePressureFrontRight":          map[string]any{"value": 2.6},
					"tirePressureRearLeft":            map[string]any{"value": 2.55},
					"tirePressureRearRight":           map[string]any{"value": 2.55},
					"tirePressureStatusFrontLeft":     map[string]any{"value": "Normal"},
					"tirePressureStatusFrontRight":    map[string]any{"value": "Normal"},
					"tirePressureStatusRearLeft":      map[string]any{"value": "Normal"},
					"tirePressureStatusRearRight":     map[string]any{"value": "Normal"},
					"doorFrontLeftClosed":             map[string]any{"value": "closed"},
					"doorFrontRightClosed":            map[string]any{"value": "closed"},
					"doorRearLeftClosed":              map[string]any{"value": "closed"},
					"doorRearRightClosed":             map[string]any{"value": "closed"},
					"closureFrunkClosed":              map[string]any{"value": "closed"},
					"closureLiftgateClosed":           map[string]any{"value": "closed"},
					"closureTailgateClosed":           map[string]any{"value": "closed"},
					"closureTonneauClosed":            map[string]any{"value": ""},
